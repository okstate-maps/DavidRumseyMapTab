...
var UI = React.createClass({
  ...
  baseUrl(){
    return "https://cdm17279.contentdm.oclc.org"
  },

  manifestUrl() {
    return this.baseUrl() + "/iiif/info/" + this.state.mapid + "/manifest.json";
    //return this.baseUrl() + "/iiif/" + this.state.mapid + "/info.json";
